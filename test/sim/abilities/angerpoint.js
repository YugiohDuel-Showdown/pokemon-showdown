...
describe('Anger Point', () => {
	...
	it('should maximize Attack when hit by a critical hit', () => {
		battle = common.createBattle([[
			...
			{ species: 'trihorndragon', ability: 'angerpoint', moves: ['endure'] },
		]]);
	...
	it('should maximize Attack when hit by a critical hit even if the foe has Mold Breaker', () => {
		battle = common.createBattle([[
			{ species: 'godslime', ability: 'moldbreaker', item: 'scopelens', moves: ['focusenergy', 'falseswipe'] },
		], [
			{ species: 'trihorndragon', ability: 'angerpoint', moves: ['defensecurl'] },
		]]);
		const angerMon = battle.p2.active[0];
	...
	it('should not maximize Attack when dealing a critical hit', () => {
		battle = common.createBattle([[
			{ species: "silentmg4", ability: "noguard", moves: ['endure'] },
		], [
			{ species: "trihorndragon", ability: "angerpoint", moves: ['stormthrow'] },
		]]);
	...
	// 	battle = common.createBattle([[
	// 		{ species: "silentmg4", ability: "noguard", item: "laggingtail", moves: ['frostbreath'] },
	// 	], [
	// 		{ species: "trihorndragon", ability: "angerpoint", moves: ["substitute"] },
	// 	]]);
	// 	const angerMon = battle.p2.active[0];
